...
texts = pd.read_csv('/Users/minhnguyen/Desktop/Project_NLP/project_nlp_2024.2/data/cleaned_corpus.csv')['text'].values.tolist()
texts = [f"passage: {text}" for text in texts]
questions = pd.read_csv('/Users/minhnguyen/Desktop/Project_NLP/project_nlp_2024.2/data/private_test.csv')['question'].values.tolist()
questions = [f"query: {clean_text(question.lower())}" for question in questions]

model_path = '/Users/minhnguyen/Desktop/Project_NLP/project_nlp_2024.2/pretrain_weight/e5_full_hard_neg'
...
corpus = pd.read_csv('/Users/minhnguyen/Desktop/Project_NLP/project_nlp_2024.2/data/corpus.csv')
question = pd.read_csv('/Users/minhnguyen/Desktop/Project_NLP/project_nlp_2024.2/data/private_test.csv')
